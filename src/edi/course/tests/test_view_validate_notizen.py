...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_validate_notizen_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='validate-notizen'
        )
        self.assertTrue(view.__name__ == 'validate-notizen')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in validate-notizen'
        # )

    def test_validate_notizen_not_matching_interface(self):
