...
#
#  $ bin/test -s edi.course -t test_checkliste.robot --all
#
...
# 2) Run robot tests:
#
# $ bin/robot /src/edi/course/tests/robot/test_checkliste.robot
#
...
a Checkliste 'My Checkliste'
  Create content  type=Lerneinheit  id=my-checkliste  title=My Checkliste
