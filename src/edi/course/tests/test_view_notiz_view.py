...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_notiz_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='notiz-view'
        )
        self.assertTrue(view.__name__ == 'notiz-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in notiz-view'
        # )

    def test_notiz_view_not_matching_interface(self):
